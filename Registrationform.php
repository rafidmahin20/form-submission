...
$igender = $birthdate = $religion = $email = $username = $password = "" ; 
$igenderErr= $birthdateErr = $religionErr = $emailErr = $usernameErr = $passwordErr = "";
$ErrorMessage="";
$flag = false;
$successfulMessage="";
$errorMessage ="";
...
if($_SERVER['REQUEST_METHOD']==="POST"){
  ...
  if(empty($birthdate)){
    $birthdateErr= "Birthdate field can not be empty";
    $flag = true;
  }
  if(empty($religion)){
...
<select name="religion" id="religion">
 ...
 <fieldset>
  ...
  <label for="perAdd">Personal Address:</label>
  <textarea id="perAdd" name="perAdd" rows="2" cols="30"> 
  </textarea>
  <br><br>
  <label for="parAdd">Parmanent Address:</label>
  <textarea id="parAdd" name="parAdd" rows="2" cols="30"> 
  </textarea> 
  <br><br>
